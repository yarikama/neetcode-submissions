...
class Twitter:
    ...
    def getNewsFeed(self, userId: int) -> List[int]:
        ...
        for i in range(10):
            ...
            print(follow_num[followee])
            print(self.user_posts[followee])
            if follow_num[followee] < len(self.user_posts[followee]):
                print(nsmallest(follow_num[followee], self.user_posts[followee]))
                next_time_stamp, next_post = nsmallest(follow_num[followee]+1, self.user_posts[followee])[follow_num[followee]]
